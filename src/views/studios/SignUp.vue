    ...
    <v-container justify-center>
      <v-layout>
        <v-col class="col-6 mx-auto">
          ...
          <v-row class="mx-auto">
              <v-text-field v-model="form.email" label="メールアドレス" color='secondary' loading type="name"></v-text-field>
          </v-row>
          <v-row class="mx-auto">
              <v-text-field v-model="form.password" label="パスワード" color='secondary' loading  type="password"></v-text-field>
          </v-row>
