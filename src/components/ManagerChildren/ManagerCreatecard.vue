...
<div class="manager-card mx-auto my-4">
  <v-card class="card">
      <v-img class="white--text align-end img" height="200px" src="https://images.unsplash.com/photo-1550657636-67d6a3a05a5d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60">
        <h2>新規作成</h2>
      </v-img>
