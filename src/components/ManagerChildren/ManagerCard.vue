<template>
  <div class="manager-card mx-auto ">
    ...
    <v-btn class="my-2  mr-2" v-show="!editingCard && !published" @click="ItemsFromCardList.published = false; saveCard(); published = !published">非公開</v-btn>
    <v-btn class="my-2  mr-2" v-show="!editingCard && published" @click="ItemsFromCardList.published = true; saveCard();  published = !published">公開</v-btn>
    ...
    <v-btn color="accent" class="my-2 mr-2 justify-end" v-show="editingCard" @click="editingCard = false; saveCard();">保存する</v-btn>
    </v-badge>
  </div>
</template>
